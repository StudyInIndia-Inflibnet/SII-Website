namespace SIIModel.StudentRegister
{
    public class Mockcounselling
    {
        ...
        public string Isalloted { get; set; }

        public string tbl_InstituteCourse_ID { get; set; }
        ...
        public string Institute_List_JSON { get; set; }
        ...
        public string SeatWaivertype { get; set; }
